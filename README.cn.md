...
[![x-cmd/install — k3sup Code Quality Monitoring Repo Card](https://repo.x-cmd.io/k3sup.svg?lang=zh)](https://x-cmd.com/install/k3sup)
...
- **Star**: 7,426 · **Fork**: 429 · **开放 issue**: 260 · **贡献者**: 49
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/k3sup.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260922.yml` · 2026-09-22T05:11:50Z._
